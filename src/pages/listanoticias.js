    ...
    <>
      <Container className="mb-5">
        <Table bordered hover responsive className="mb-3 table">
          <thead>
            <tr>
              <th className="text-center fw-bold bg-warning-subtle">ID</th>
              ...
              <th className="text-center fw-bold bg-warning-subtle">data</th>
              <th className="text-center fw-bold bg-warning-subtle">Update</th>
              <th className="text-center fw-bold bg-warning-subtle">Delete</th>
            </tr>
          </thead>
          <tbody>
            {noticias.map((noticia) => (
              <Tablelist
                key={noticia._id}
                idnoticia={noticia._id} /* alterar aqui */
